...
.garden-shell{
  ...
  padding:28px;
  background:
    linear-gradient(#334b31aa,#334b3170),
...
.side-btn{
  ...
  text-align:left;
  color:#f4e5c7;
  background:linear-gradient(145deg,#38553e,#2d4434);
  border:1px solid #806043;
  border-radius:21px;
...
.modal{
  ...
  z-index:5000;
  background:
    radial-gradient(circle at top,#294536,#17261e 65%);
  border:3px solid #866142;
  border-radius:30px;
...
.modal-head{
  ...
  align-items:center;
  gap:20px;
  border-bottom:1px solid #72553a;
  padding-bottom:17px;
  margin-bottom:20px;
}
.modal-head h2{
